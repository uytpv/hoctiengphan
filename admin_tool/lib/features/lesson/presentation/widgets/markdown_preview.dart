  ...
  Widget build(BuildContext context) {
    ...
    return MarkdownBody(
      ...
      styleSheet: MarkdownStyleSheet(
        ...
        h1: const TextStyle(fontSize: 20, fontWeight: FontWeight.bold, height: 1.4, color: Colors.blueAccent),
        h2: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, height: 1.4, color: Colors.blueAccent),
        h3: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, height: 1.4, color: Colors.blueAccent),
