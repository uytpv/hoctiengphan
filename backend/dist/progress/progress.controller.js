...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'User progress details' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update task progress' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Task progress updated' }),
    __param(0, (0, user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, update_task_dto_1.UpdateTaskDto]),
    __metadata("design:returntype", void 0)
], ProgressController.prototype, "updateTaskProgress", null);
