...
- [ ] **Type Centralization**: Thiết lập và sử dụng `@andromeda/shared-types` cho cả Backend và Frontend (Rule III.2).
- [ ] **Naming Convention**: Chuyển đổi tên Files/Components sang `PascalCase` cho toàn bộ dự án (Rule III.3).
